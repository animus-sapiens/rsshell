...
public class SystemInformation {
  ...
  private static String getOsInfo() {
    ...
    fullOsInfo
        .append("OS: ")
        .append(
            operatingSystem.getFamily().toString()
                + " "
                + operatingSystem.getVersionInfo().getVersion().toString())
        .append(lineSeparator)
        .append(lineSeparator)
        .append("File System: ")
        .append(
    ...
    fullOsInfo
        ...
        .append(lineSeparator)
        .append("Processes: ")
        .append(operatingSystem.getProcesses().toArray().length)
        .append(lineSeparator)
        .append(lineSeparator)
        .append("Services: ")
        .append(operatingSystem.getServices().toArray().length);
  ...
  private static String printMemory() {
    ...
    memoryInfo
        .append("RAM Memory: ")
        .append(globalMemory.toString())
        .append(lineSeparator)
        .append(lineSeparator);
    VirtualMemory vm = globalMemory.getVirtualMemory();
    memoryInfo
        .append("Virtual Memory: ")
        .append(vm.toString())
        .append(lineSeparator)
        .append(lineSeparator);
  ...
  private static String getHardwareInfo() {
    ...
    fullHardwareInfo
        .append("Motherboard: ")
        .append(hardwareLayer.getComputerSystem().getBaseboard().getModel())
        .append(lineSeparator)
        .append(lineSeparator)
        .append("Motherboard Model: ")
        .append(hardwareLayer.getComputerSystem().getModel())
        .append(lineSeparator)
        .append(lineSeparator)
        .append("Disks: ")
        .append(lineSeparator);
    ...
    for (HWDiskStore disk : hardwareLayer.getDiskStores()) {
      fullHardwareInfo.append(
          "\tDisk " + i + ": " + disk.toString().replace("\n", lineSeparator + "\t      "));
      i++;
    ...
    if (hardwareLayer.getNetworkIFs().isEmpty()) {
      ...
      for (NetworkIF net : hardwareLayer.getNetworkIFs()) {
        fullHardwareInfo
            .append(lineSeparator)
            .append("\tIF " + i + ": " + net.toString().replace("\n", lineSeparator + "\t    "));
        i++;
      }
    }
    ...
    for (Display display : hardwareLayer.getDisplays()) {
      ...
      fullHardwareInfo.append(
          String.valueOf(display).replace("\n", lineSeparator + "\t           "));
      i++;
    }
